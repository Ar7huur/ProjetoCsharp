...
namespace SalesWebMVC.Data {
    public class SeedingService {
        ...
        //operação responsável para popular base de dados
        public void Seed() {
            //verificar se exite dados na base de dados..
            if (_context.Departament.Any() || _context.Seller.Any() || _context.SalesRecords.Any()) {
                return; //se tiver o return, significa que o bd já foi populado..
            }
            //Departamentos
            ...
            //Vendedores
            Seller s1 = new Seller(1, "Roberto Alves", "roberto@gmail.com", new DateTime(1998,4,21),1000.0,d1);
            Seller s2 = new Seller(2, "Cristina Silva", "cristina@gmail.com", new DateTime(1992,2,23),1200.0,d2);
            Seller s3 = new Seller(3, "Jorge Marques", "jorgemarques@hotmail.com", new DateTime(1995,5,25),1300.0,d1);
            Seller s4 = new Seller(4, "Vinicius Souza", "viniciuss@outlook.com", new DateTime(1990,6,12),2000.0,d4);
            Seller s5 = new Seller(5, "Lucas Rocha", "rochalucas@live.com", new DateTime(1991,10,12),3000.0,d3);
            Seller s6 = new Seller(6, "Suzane Pereira", "suzpereira@gmail.com", new DateTime(1989,12,13),3500.0,d2);
            ...
            //Operação usando o entityframework para adicionar os dados acima no banco de dados.
            _context.Departament.AddRange(d1, d2, d3, d4); //add range vai adicionar todos de uma só vez no bd.
            ...
            //salva e confirma os dados no banco de dados.
